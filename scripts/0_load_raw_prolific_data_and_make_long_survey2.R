...
# Read varnames
df_names<-as.character(read_excel("rawdata\\Voices_Expert_NoInstitution_Prolific_20 September 2024_10.51.xlsx", n_max=1, col_names = FALSE))

# Read data
df<-read_excel("rawdata\\Voices_Expert_NoInstitution_Prolific_20 September 2024_10.51.xlsx", skip=2,col_names = df_names)
...
df<-df %>%
  clean_names()
write_dta(df,"temporarydata\\cleaned_data_survey_2.dta")
